...
@testset "Digital Nets" begin
    ...
    @testset "CheckCorrectQMCPoints" begin
        QMCPoints=[0
        0.5
        0.75
        0.25
        ...
        for id=1:len
            @test  QMCPoints[id] == QMCPointsFromdigital_net64[id][1]
            @test  QMCPoints[id] == QMCPointsFromdigital_net32[id][1]
        end
